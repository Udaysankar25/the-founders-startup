        ...
        >
          <div className="w-full max-w-[530px]">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              {/* Email Field */}
              <div>
                <label className="block font-semibold mb-1 text-[#800080]">
                  E-mail
                </label>
                <input
                  type="email"
        ...
        >
          <div className="bg-white/10 border border-white/30 rounded-[20px] p-4 md:p-6 text-center max-w-md w-full">
            ...
            <p className="text-sm md:text-base">
              Don’t worry, investor. We’ll help you securely reset your password
              and get back to discovering startups.
            </p>
          </div>
        </div>
      </div>
