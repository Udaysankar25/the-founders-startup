  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const payload = {
        email,
        profilePicture:
          step1.profilePicture && typeof step1.profilePicture === "string"
      ...
      await apiCall("/api/auth/complete-signup", "POST", payload);
        ...
        >
          <div className="bg-white/10 border border-white/30 rounded-[20px] p-4 md:p-6 text-center max-w-md w-full">
            ...
            <p className="text-sm md:text-base">
              Build your presence. Add LinkedIn, GitHub, or your personal site
              to show you're real and ready.
            </p>
          </div>
        </div>
